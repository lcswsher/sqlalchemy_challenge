...
def home_page():
    ...
    return (
        ...
        f"<br/>"
        f"Precipitation data by date:<br/>"
        f"<br/>"
        f"/api/v1.0/precipitaion<br/>"
        f"<br/>"
        f"List of stations by name:<br/>"
        f"<br/>"
        f"/api/v1.0/stations<br/>"
        f"<br/>"
        f"List of temperature observations for station USC00519281 for dates 08/24/2016 - 08/23/2017:<br/>"
        f"<br/>"
        f"/api/v1.0/tobs<br/>"
        f"<br/>"
        f"Min, Max, Avg Temperatures by Start Date.<br/>"
        f"Input date format YYYY-MM-DD for start date:<br/>"
        f"<br/>"
        f"/api/v1.0/&lt;start&gt;<br>"
        f"<br/>"
        f"Min, Max, Avg Temperatures by Start and End Dates.<br/>"
        f"Input date format YYYY-MM-DD for both start and end dates (separated by / ):<br/>"
        f"<br/>"
